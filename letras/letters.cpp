...
//     #include <windows.h>
    ...
    void getContours(const char* filename)
    {
      ...
      // cv::GaussianBlur(img,img,size,0);
       adaptiveThreshold(img, img, 255, ADAPTIVE_THRESH_MEAN_C, THRESH_BINARY, 7, 15);
    ...
    // cvtColor(cropped3,cropped3,CV_GRAY2RGB);
     ...
     vector<vector<Point> > contours;
      ...
      /// Find contours
      cv:: findContours( img2, contours, hierarchy, CV_RETR_EXTERNAL, CV_CHAIN_APPROX_SIMPLE, Point(0, 0) );
